                                    ...
                                    <div className="row">
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                                            <div className="tp-service__item mb-30">
                                                ...
                                                <div className="tp-service__content">
                                                    <h3 className="tp-service__title-sm tp-orange-color"><a href="service-details.html">AI Data Analysis</a></h3>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                                            <div className="tp-service__item mb-30">
                                                ...
                                                <div className="tp-service__content">
                                                    <h3 className="tp-service__title-sm tp-theme-color"><a href="service-details.html">Machine Learning</a></h3>
                                                    <p>Lorem Ipsum is simply dummy text <br />
                                                        of the printing</p>
                                                </div>
                                                <div className="tp-service__link">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                                            <div className="tp-service__item mb-30">
                                                ...
                                                <div className="tp-service__content">
                                                    <h3 className="tp-service__title-sm tp-purple-color"><a href="service-details.html">Data Visualization</a></h3>
                                                    <p>Lorem Ipsum is simply dummy text <br />
                                                        of the printing</p>
                                                </div>
                                                <div className="tp-service__link">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                                            <div className="tp-service__item mb-30">
                                                ...
                                                <div className="tp-service__content">
                                                    <h3 className="tp-service__title-sm tp-green-color"><a href="service-details.html">Business Intelligence</a></h3>
                                                    <p>Lorem Ipsum is simply dummy text <br />
                                                        of the printing</p>
                                                </div>
                                                <div className="tp-service__link">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                                            <div className="tp-service__item mb-30">
                                                ...
                                                <div className="tp-service__content">
                                                    <h3 className="tp-service__title-sm tp-yellow-color"><a href="service-details.html">Artificial Intelligence</a></h3>
                                                    <p>Lorem Ipsum is simply dummy text <br />
                                                        of the printing</p>
                                                </div>
                                                <div className="tp-service__link">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                                            <div className="tp-service__dashboard" data-background="assets/img/service/sv-bg.jpg">
                                                ...
                                                <div className="tp-service__dashdboard-sm-img">
                                                    <img className="wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s" src="assets/img/service/sv-dashbord.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <div className="tp-project__item d-flex align-items-center">
                                                                    ...
                                                                    <div className="tp-project__content">
                                                                        ...
                                                                        <div className="tp-project__title-box">
                                                                            <h4 className="tp-project__title-sm"><a href="project-details.html">Muckup Design</a></h4>
                                                            ...
                                                            <div className="tp-project__slider-wrapper">
                                                                <div className="tp-project__item d-flex align-items-center">
                                                                    ...
                                                                    <div className="tp-project__content">
                                                                        ...
                                                                        <div className="tp-project__title-box">
                                                                            <h4 className="tp-project__title-sm"><a href="project-details.html">3d Design</a></h4>
                                                                            <p>Excepteur sint occaecat cupidatat officia non
                                                                                proident, sunt in culpa qui deserunt mollit anim
                                                                                id est laborum.
                                                                            </p>
                                                            ...
                                                            <div className="tp-project__slider-wrapper">
                                                                <div className="tp-project__item d-flex align-items-center">
                                                                    ...
                                                                    <div className="tp-project__content">
                                                                        ...
                                                                        <div className="tp-project__title-box">
                                                                            <h4 className="tp-project__title-sm"><a href="project-details.html">App Design</a></h4>
                                                                            <p>Excepteur sint occaecat cupidatat officia non
                                                                                proident, sunt in culpa qui deserunt mollit anim
                                                                                id est laborum.
                                                                            </p>
                                                            ...
                                                            <div className="tp-project__slider-wrapper">
                                                                <div className="tp-project__item d-flex align-items-center">
                                                                    ...
                                                                    <div className="tp-project__content">
                                                                        ...
                                                                        <div className="tp-project__title-box">
                                                                            <h4 className="tp-project__title-sm"><a href="project-details.html">Graphic Design</a></h4>
                                                                            <p>Excepteur sint occaecat cupidatat officia non
                                                                                proident, sunt in culpa qui deserunt mollit anim
                                                                                id est laborum.
                                                                            </p>
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-xl-10">
                                            <div className="tp-testimonial__slider-section">
                                                <div className="tp-testimonial__slider-active wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                                        ...
                                        <div className="col-xl-7 col-lg-7 order-0 order-lg-2">
                                            <div className="tp-rank__wrapper p-relative">
                                                ...
                                                <div className="tp-rank__bg-shape">
                                                    <img className="wow tpfadeRight" data-wow-duration=".9s" data-wow-delay="1.2s" src="assets/img/rank/rank-bg-shape.png" alt="" />
                                                </div>
                                            ...
                                            <div className="tp-price__btn-box p-relative mb-50 d-flex justify-content-center">
                                                ...
                                                <nav>
                                                    <div className="nav nav-tab tp-price__btn-bg" id="nav-tab" role="tablist">
                                                        <button className="nav-link active monthly" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Monthly</button>
                                                        <button className="nav-link yearly" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Yearly</button>
                                    ...
                                    <div className="container">
                                        ...
                                        <div className="tp-footer__top-space">
                                            <div className="row">
                                                ...
                                                <div className="col-xl-3 col-lg-3 col-md-5 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                                                ...
                                                <div className="col-xl-2 col-lg-2 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                                                        ...
                                                        <div className="tp-footer__contact-info tp-footer__icon-space">
                                                            <ul>
                                                                <li>
                                                                    <span>
                                                                        <svg width="22" height="22" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M14.332 1C14.332 1 17.2651 1.26664 20.9981 4.99966C24.7311 8.73267 24.9978 11.6658 24.9978 11.6658" stroke="#FF3C82" stroke-width="2" stroke-linecap="round" />
                                                                            <path d="M14.6079 5.71289C14.6079 5.71289 15.9277 6.08998 17.9075 8.06971C19.8872 10.0494 20.2643 11.3693 20.2643 11.3693" stroke="#FF3C82" stroke-width="2" stroke-linecap="round" />
                                                                            <path opacity="0.5" d="M9.04943 5.42369L9.91471 6.97413C10.6956 8.37332 10.3821 10.2088 9.15225 11.4387C9.15225 11.4387 9.15225 11.4387 9.15225 11.4387C9.15213 11.4388 7.66057 12.9306 10.3652 15.6352C13.0692 18.3392 14.561 16.849 14.5618 16.8482C14.5618 16.8482 14.5618 16.8482 14.5618 16.8482C15.7917 15.6183 17.6271 15.3049 19.0263 16.0857L20.5768 16.951C22.6896 18.1301 22.9391 21.0931 21.082 22.9502C19.9661 24.0661 18.599 24.9344 17.0878 24.9917C14.5439 25.0882 10.2236 24.4443 5.88985 20.1106C1.55612 15.7769 0.912294 11.4566 1.00873 8.91261C1.06602 7.40143 1.93432 6.03439 3.05023 4.91848C4.90734 3.06137 7.87031 3.31089 9.04943 5.42369Z" stroke="#FF3C82" stroke-width="2" stroke-linecap="round" />
                                                                        </svg>
                                                                    </span>
                                                                ...
                                                                <li>
                                                                    <span>
                                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 10.2797 1.30049 11.4893 1.83477 12.562C1.97675 12.847 2.02401 13.1729 1.94169 13.4805L1.46521 15.2613C1.25836 16.0344 1.96561 16.7416 2.73868 16.5348L4.51951 16.0583C4.82715 15.976 5.15297 16.0233 5.43802 16.1652C6.51069 16.6995 7.72025 17 9 17Z" stroke="#FF3C82" stroke-width="1.5" />
                                                                            <path opacity="0.5" d="M5.7998 7.80078H12.1998" stroke="#FF3C82" stroke-width="1.5" stroke-linecap="round" />
                                                                            <path opacity="0.5" d="M5.7998 10.6006H10.1998" stroke="#FF3C82" stroke-width="1.5" stroke-linecap="round" />
                                                                        </svg>
                                                                    </span>
                                                                ...
                                                                <li>
                                                                    <span>
                                                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path opacity="0.5" d="M3.7002 6.86317C3.7002 3.62503 6.5208 1 10.0002 1C13.4796 1 16.3002 3.62503 16.3002 6.86317C16.3002 10.0759 14.2895 13.8249 11.1523 15.1656C10.4209 15.4781 9.57947 15.4781 8.84814 15.1656C5.71094 13.8249 3.7002 10.0759 3.7002 6.86317Z" stroke="#FF3C82" stroke-width="1.5" />
                                                                            <path d="M11.8002 7.3C11.8002 8.29411 10.9943 9.1 10.0002 9.1C9.00608 9.1 8.2002 8.29411 8.2002 7.3C8.2002 6.30589 9.00608 5.5 10.0002 5.5C10.9943 5.5 11.8002 6.30589 11.8002 7.3Z" stroke="#FF3C82" stroke-width="1.5" />
                                                                            <path d="M18.0645 13.1504C18.6633 13.6926 19 14.3038 19 14.9504C19 17.1871 14.9706 19.0004 10 19.0004C5.02944 19.0004 1 17.1871 1 14.9504C1 14.3038 1.33671 13.6926 1.93552 13.1504" stroke="#FF3C82" stroke-width="1.5" stroke-linecap="round" />
                                                                        </svg>
                                                                    </span>
