...
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselWrapperAriaLabel":"Carousel | Horizontal scrolling: Arrow Left & Right","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}}},"version":"3.18.3","is_static":false,"experimentalFeatures":{"e_dom_optimization":true,"e_optimized_assets_loading":true,"e_optimized_css_loading":true,"additional_custom_breakpoints":true,"e_swiper_latest":true,"block_editor_assets_optimize":true,"landing-pages":true,"e_image_loading_optimization":true,"e_global_styleguide":true},"urls":{"assets":"https:\/\/phox.whmcsdes.com\/demos\/classy-pro\/wp-content\/plugins\/elementor\/assets\/"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":11,"title":"Phox%20%E2%80%93%20Classy%20Pro","excerpt":"","featuredImage":false}};
...
if($scope.find(".wdes-table-search").length===1){options.widgets=["zebra","filter"];options.widgetOptions={filter_columnFilters:!1}}
if($target.hasClass("wdes-table-sorting")){console.log("qwe",$scope.find(".wdes-table-search"));var $table=$target.tablesorter(options);$.tablesorter.filter.bindSearch($table,$scope.find(".wdes-table-search"))}},elementWorldMap:function($scope){var setting=$scope.find("#wdes-world-map").data("settings"),data=$scope.find("#wdes-world-map").data("countries"),lats=data.map(function(zone){return zone.latitude}),long=data.map(function(zone){return zone.longitude}),targetSVG="M9,0C4.029,0,0,4.029,0,9s4.029,9,9,9s9-4.029,9-9S13.971,0,9,0z M9,15.93 c-3.83,0-6.93-3.1-6.93-6.93S5.17,2.07,9,2.07s6.93,3.1,6.93,6.93S12.83,15.93,9,15.93 M12.5,9c0,1.933-1.567,3.5-3.5,3.5S5.5,10.933,5.5,9S7.067,5.5,9,5.5 S12.5,7.067,12.5,9z",planeSVG="m2,106h28l24,30h72l-44,-133h35l80,132h98c21,0 21,34 0,34l-98,0 -80,134h-35l43,-133h-71l-24,30h-28l15,-47",addTarget=data.map((zone)=>{zone.svgPath=targetSVG;return zone}),planShadowStyle={svgPath:planeSVG,positionOnLine:0,color:setting.movingObject.shadowColor,alpha:0.1,animateAlongLine:!0,lineId:"line2",flipDirection:!0,loop:!0,scale:0.03,positionScale:1.3,},planStyle={svgPath:planeSVG,positionOnLine:0,color:setting.movingObject.color,animateAlongLine:!0,lineId:"line1",flipDirection:!0,loop:!0,scale:0.03,positionScale:1.8,},zoomLevel=setting.settings.home.zoom!=null?setting.settings.home.zoom:1,zoomLongitude=setting.settings.home.longitude!=null?setting.settings.home.longitude:11.4953,zoomLatitude=setting.settings.home.latitude!=null?setting.settings.home.latitude:13.5341;addTarget.push(planShadowStyle,planStyle);AmCharts.makeChart("chartdiv",{type:"map",theme:"light",projection:"winkel3",dataProvider:{map:"worldLow",zoomLevel:zoomLevel,zoomLongitude:zoomLongitude,zoomLatitude:zoomLatitude,lines:[{id:"line1",arc:-0.85,alpha:0.3,latitudes:lats,longitudes:long,},{id:"line2",alpha:0,color:"#000000",latitudes:lats,longitudes:long,},],images:addTarget,},areasSettings:{unlistedAreasColor:setting.areasSettings.unlistedAreasColor,unlistedAreasOutlineColor:setting.areasSettings.unlistedAreasOutlineColor,},imagesSettings:{color:setting.imagesSettings.color,rollOverColor:setting.imagesSettings.rollOverColor,selectedColor:"#ffffff",pauseDuration:0.2,animationDuration:4,adjustAnimationSpeed:!0,},linesSettings:{color:setting.line.linesSettings,alpha:0.4,},export:{enabled:!0,},})},elementDomainSearch:function($scope,$){var DomainCheck={submit:function(e){e.preventDefault();var obj=e.data,el=obj.wap.find("#wdes-domain-results"),domainDefault="whmcsdes.com",inputDomain=psl.parse(obj.input.val()).domain===null?obj.input.val()+".com":obj.input.val(),parsed=psl.parse(inputDomain),basename=obj.input.val()!==""?parsed.domain:domainDefault;obj.security=obj.form.find("input[name=security]").val();var dcErrorMess=$scope.find("#dc-error-message-invalid"),dcErrorUnsupportedMess=$scope.find("#dc-error-message-unsupported"),filterlocaltlds=obj.localTlds!=null?obj.localTlds.filter(function(value){return value===parsed.tld}):[parsed.tld];obj.el=el;if(psl.isValid(inputDomain)&&filterlocaltlds.length>0){if(dcErrorMess.hasClass("d-block")){dcErrorMess.removeClass("d-block").addClass("d-none")}
if(dcErrorUnsupportedMess.hasClass("d-block")){dcErrorUnsupportedMess.removeClass("d-block").addClass("d-none")}
var domainData={},spinnerIcon=obj.setting.spinnerIcon.length>0?obj.setting.spinnerIcon:"",domainResultTable=$('<div id="wdes_result_item" class="wdes-result-domain-box" role="alert"> </div>'),domainResult=$('<div class="inner-block-result-item">'+'<div class="spinner wdes-loading-results">'+'<i class="'+spinnerIcon+' fa-spin fa-lg fa-fw"></i>'+'<span class="sr-only">...</span>'+"</div>"+"</div>");$.extend(domainData,obj);domainData.domain=basename.replace(/<[^>]*>?/gm,"");domainData.el=domainResult;domainData.parsed=parsed;domainData.submit=obj.submit;domainData.lupid=e.data.LUPId;domainResult.data("domain",domainData.domain);if(obj.el.find("#wdes_result_item").length<0){obj.el.append(domainResultTable);obj.el.find("#wdes_result_item").append(domainResult)}else{obj.el.find("#wdes_result_item").remove();obj.el.append(domainResultTable);obj.el.find("#wdes_result_item").append(domainResult)}
obj.el.find("#wdes_result_item").append('<span class="results-wdes-dom">'+domainData.domain+"</span>");if(domainData.form.find("#wdes-dc-more-options ul").length>0){domainData.form.find("#wdes-dc-more-options ul").remove();domainData.form.find("#wdes-dc-more-options").addClass("d-none")}
...
$(".wdes-nav-mobile-close-btn",$scope).on("click.wdesMobileNavMenu",function(event){$(this).closest(".wdes-nav-wrap").removeClass(mobileActiveClass)});var initMobileFullWidthCss=!1;setFullWidthMenuPosition();$(window).on("resize.wdesMobileNavMenu",setFullWidthMenuPosition);function setFullWidthMenuPosition(){var mobileLayout=$scope.find(".wdes-nav-wrap").data("mobile-layout");if("full-width"!==mobileLayout){return}
var $menu=$scope.find(".wdes-nav"),currentDeviceMode=elementorFrontend.getCurrentDeviceMode();if("mobile"!==currentDeviceMode){if(initMobileFullWidthCss){$menu.css({left:""});initMobileFullWidthCss=!1}
return}
...
initmarker=new google.maps.Marker(markerData);if(""!==marker.desc){infowindow=new google.maps.InfoWindow({content:marker.desc,disableAutoPan:!0,})}
initmarker.addListener("click",function(){infowindow.setOptions({disableAutoPan:!1});infowindow.open(map,initmarker)});if("visible"===marker.state&&""!==marker.desc){infowindow.open(map,initmarker)}})}},elementorPortfolio:function($scope){var _helper={removeSpaceFromString:function(string){return string.toLowerCase().split(" ").join("")},visibleAnime:function(target){anime({targets:target,opacity:{value:1,duration:400,},scale:{value:1,duration:500,easing:"easeOutExpo",},delay:50,elasticity:!1,});$(target).addClass("visible-status");$(target).removeClass("hidden-status")},hiddenAnime:function(target){anime({targets:target,opacity:0,scale:0,delay:500,elasticity:!1,});$(target).removeClass("visible-status");$(target).addClass("hidden-status")},isRTL:function(){return $("body").hasClass("rtl")},getJustifyItemLayout:function(width,height){var size="justify-size-1-4",ratio=width/height;if(this.rangeCheck(ratio,0,1)){size="justify-size-1-4"}
...
attrs["class"]=classPrefix+"item";if(settingsData.layout.type==="justify"){attrs["class"]+=" "+_helper.getJustifyItemLayout(this.model.get("item_image").width,this.model.get("item_image").height)}
...
if(showAgainDate<Date.now()){return!0}else{return!1}},self.getLocalStorageData=function(){try{return JSON.parse(localStorage.getItem('wdesPopupData'))}catch(e){return!1}}
self.setLocalStorageData=function(id,status){var wdesPopupData=self.getLocalStorageData()||{},newData={};newData.status=status;if('disable'===status){var nowDate=Date.now(),showAgainDelay=settings['show-again-delay'],showAgainDate='none'!==showAgainDelay?(nowDate+showAgainDelay):'none';newData['show-again-date']=showAgainDate}
wdesPopupData[id]=newData;localStorage.setItem('wdesPopupData',JSON.stringify(wdesPopupData))},self.openModal=function(){switch(settings['open-trigger']){case 'page-load':self.pageLoad(settings['page-load-delay']);break;case 'user-inactive':self.userInactive(settings['user-inactivity-time'])
break;case 'scroll-trigger':self.scrollPage(settings['scrolled-to']);break;case 'try-exit-trigger':self.tryExit();break;case 'on-date':self.onDate(settings['on-date']);break;case 'on-time':self.onTime(settings['on-time-start'],settings['on-time-end']);break}},self.pageLoad=function(delayValue){let delay=Number.isInteger(delayValue)?delayValue:0;delay=delay*1000;setTimeout(function(){self.MicroModalInit()},delay)},self.userInactive=function(delayValue){var delay=Number.isInteger(delayValue)?delayValue:0,isInactive=!0;delay=delay*1000;setTimeout(function(){if(isInactive){self.MicroModalInit()}},delay);$(document).on('click focus resize keyup scroll',function(){isInactive=!1})},self.scrollPage=function(scrollingValue){var scrollValue=Number.isInteger(scrollingValue)?scrollingValue:0;$window.on('scroll resize',function(){let windowHeight=$window.height(),documentHeight=$(document).height(),scrolledHeight=documentHeight-windowHeight,scrolledProgress=Math.max(0,Math.min(1,$window.scrollTop()/scrolledHeight))*100;if(scrolledProgress>=scrollValue){$window.off('scroll resize');self.MicroModalInit()}})},self.tryExit=function(){var pageY=0;$(document).on('mouseleave','body',function(event){pageY=event.pageY-$window.scrollTop();if(0>pageY&&!popup.hasClass('is-open')){self.MicroModalInit()}})},self.onDate=function(date){var nowDate=Date.now(),startDate=Date.parse(date);if(startDate<nowDate){setTimeout(function(){self.MicroModalInit()},500)}},self.onTime=function(startTime='00:00',endTime='23:59'){var startTime=''!==startTime?startTime:'00:00',endTime=''!==endTime?endTime:'23:59',nowTimeStamp=Date.now(),dateTimeFormat=new Intl.DateTimeFormat('en',{year:'numeric',month:'short',day:'2-digit'}),[{value:month},,{value:day},,{value:year}]=dateTimeFormat.formatToParts(nowTimeStamp),startTime=`${ month }. ${ day }, ${ year } ${ startTime }`,endTime=`${ month }. ${ day }, ${ year } ${ endTime }`,startTimeStamp=Date.parse(startTime),endTimeStamp=Date.parse(endTime);if((startTimeStamp<nowTimeStamp)&&(nowTimeStamp<endTimeStamp)){setTimeout(function(){self.MicroModalInit()},500)}},self.MicroModalInit=function(){let activePopupElement=settings['wdes-popup-id'];MicroModal.show(settings['wdes-popup-id'],{onShow:function(modle,activePopupElement){let $overlayElement=$('.wdes-popup-overlay',modle),animeOverlayInstance=null,animeOverlaySettings=$.extend({targets:$overlayElement[0]},self.animeEffects.fade.show),$contentElement=$('.wdes-popup-container',modle),animeContentInstance=null,animeContentSettings=$.extend({targets:$contentElement[0]},self.animeEffects[settings.animation].show);if(!self.availableCheck||isEditor){return!1}
animeOverlayInstance=anime(animeOverlaySettings);animeContentInstance=anime(animeContentSettings)},onClose:function(modle){let $overlayElement=$('.wdes-popup-overlay',modle),animeOverlayInstance=null,animeOverlaySettings=$.extend({targets:$overlayElement[0]},self.animeEffects.fade.hide),$contentElement=$('.wdes-popup-container',modle),animeContentInstance=null,animeContentSettings=$.extend({targets:$contentElement[0]},self.animeEffects[settings.animation].hide),constantly=settings['show-once'];if(constantly){self.setLocalStorageData(popupId,'disable')}
animeOverlayInstance=anime(animeOverlaySettings);animeContentInstance=anime(animeContentSettings);$(modle).addClass('is-close')},disableScroll:settings['prevent-scrolling'],awaitCloseAnimation:!0})}
self.animeEffects={'fade':{'show':{delay:200,opacity:{value:[0,1],duration:600,easing:'easeOutQuart',},},'hide':{easing:'easeOutQuart',opacity:{value:[1,0],duration:400,easing:'easeOutQuart',},}},'zoom-in':{'show':{duration:500,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},scale:{value:[0.75,1]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},scale:{value:[1,0.75]}}},'zoom-out':{'show':{duration:500,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},scale:{value:[1.25,1]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},scale:{value:[1,1.25]}}},'rotate':{'show':{duration:500,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},scale:{value:[0.75,1]},rotate:{value:[-65,0]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},scale:{value:[1,0.9]}}},'move-up':{'show':{duration:500,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},translateY:{value:[50,1]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},translateY:{value:[1,50]}}},'flip-x':{'show':{duration:1000,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},rotateX:{value:[65,0]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],}}},'flip-y':{'show':{duration:1000,delay:200,easing:'easeOutQuart',opacity:{value:[0,1]},rotateY:{value:[65,0]}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],}}},'bounce-in':{'show':{duration:1000,opacity:{value:[0,1],delay:500,easing:'easeOutQuart',},scale:{value:[0.2,1],delay:800,elasticity:function(el,i,l){return(400+i*200)},}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},scale:{value:[1,0.8]}}},'bounce-out':{'show':{duration:200,opacity:{value:[0,1],delay:500,easing:'easeOutQuart',},scale:{value:[1.8,1],delay:800,elasticity:function(el,i,l){return(400+i*200)},}},'hide':{duration:400,easing:'easeOutQuart',opacity:{value:[1,0],},scale:{value:[1,1.5]}}},'slider-in-up':{'show':{delay:200,opacity:{value:[0,1],duration:400,easing:'easeOutQuart',},translateY:{value:['100vh',0],duration:750,easing:'easeOutQuart',}},'hide':{duration:400,easing:'easeInQuart',opacity:{value:[1,0],},translateY:{value:[0,'100vh'],}}},'slider-in-right':{'show':{delay:200,opacity:{value:[0,1],duration:400,easing:'easeOutQuart',},translateX:{value:['100vh',0],duration:750,easing:'easeOutQuart',}},'hide':{duration:400,easing:'easeInQuart',opacity:{value:[1,0],},translateX:{value:[0,'100vh']}}},'slider-in-down':{'show':{delay:200,opacity:{value:[0,1],duration:400,easing:'easeOutQuart',},translateY:{value:['-100vh',0],duration:750,easing:'easeOutQuart',}},'hide':{duration:400,easing:'easeInQuart',opacity:{value:[1,0],},translateY:{value:[0,'-100vh']}}},'slider-in-left':{'show':{delay:200,opacity:{value:[0,1],duration:400,easing:'easeOutQuart',},translateX:{value:['-100vh',0],duration:750,easing:'easeOutQuart',}},'hide':{duration:400,easing:'easeInQuart',opacity:{value:[1,0],},translateX:{value:[0,'-100vh']}}},}}}
$(window).on('elementor/frontend/init',WdesPopupFrontend.init)}(jQuery,window.elementorFrontend));
